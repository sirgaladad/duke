...
(function(){
  ...
  const PR_LOG = [
    { spId: "alligator_gar",   weight: 38.0, lenIn: 56, date: "2026-02-11", lake: "Lower White River",   trophy: true },
    { spId: "brown_trout",     weight: 11.4, lenIn: 28, date: "2026-03-12", lake: "Bull Shoals Tailwater", trophy: true },
    { spId: "channel_catfish", weight: 6.80, lenIn: 24, date: "2026-02-19", lake: "Lake Conway" },
    { spId: "largemouth_bass", weight: 5.85, lenIn: 21, date: "2026-03-22", lake: "Lake Conway" },
    { spId: "walleye",         weight: 5.20, lenIn: 22, date: "2026-02-28", lake: "Greers Ferry" },
    { spId: "smallmouth_bass", weight: 4.10, lenIn: 19, date: "2026-03-09", lake: "Crooked Creek" },
    { spId: "white_bass",      weight: 2.80, lenIn: 16, date: "2026-02-24", lake: "Beaver Lake" },
    { spId: "rainbow_trout",   weight: 2.10, lenIn: 15, date: "2026-04-02", lake: "Norfork Tailwater" }
  ];
  ...
  // Format an ISO date string (YYYY-MM-DD) to a short readable label like "Feb 11 '26".
          ...
          <div key={p.spId} style={prRow}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10, color: "var(--pfg-fg-muted)", marginTop: 2 }}>
                {p.lake} · {fmtDate(p.date)} · {p.group.label}
              </div>
            </div>
          </div>
        ))}
